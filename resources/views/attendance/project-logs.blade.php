...
<h2 class="text-3xl font-semibold text-gray-900 tracking-tight">
    Attendance Logs — {{ $project->project_name }}
</h2>
@endsection
...
<div class="glass-table">
    ...
    <table id="projLogsTable" class="w-full border-collapse text-left">
        <thead>
            <tr>
                <th onclick="sortTable('projLogsTable',0)">
                    Employee
                </th>
                <th onclick="sortTable('projLogsTable',1)">
                    Date
                </th>
                <th onclick="sortTable('projLogsTable',2)">
                    Time In
                </th>
                <th onclick="sortTable('projLogsTable',3)">
                    Time Out
                </th>
                <th onclick="sortTable('projLogsTable',4)">
                    Hours
                </th>
                <th onclick="sortTable('projLogsTable',5)">
                    Status
                </th>
            </tr>
        </thead>
